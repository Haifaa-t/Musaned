...
export default function ContactUsSection() {
  ...
  return (
    <section className="w-full bg-white px-4 sm:px-6 lg:px-32 pt-12 pb-16">
      <div className="max-w-[1280px] mx-auto">
        <div className="border border-[#D2D6DB] rounded-lg bg-white p-6 sm:p-8 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-[16px] font-bold text-[#1F2A37] leading-[24px]">
              {title}
            </h3>
            <p className="text-[14px] text-[#4B5563] leading-[22px] max-w-[768px]">
              {description}
            </p>
          </div>
